<template>
    <div class="rating_page">
        ...
        <section class="shop_status_container">
            ...
            <section class="shop_statu_detail">
                ...
                <div class="check_date">
                    <p>
                        <span>监督检查结果:</span>
                        <span class="shop_statuss_well" v-if="shopDetail.status == 1">良好</span>
        ...
        <section class="shop_status_info">
            ...
            <p @click="showLicenseImg(shopDetaill.license.catering_service_license_image)">
                <span>餐饮服务许可证</span>
                <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" version="1.1" class="description_arrow" >
                    <path d="M0 0 L8 7 L0 14"  stroke="#bbb" stroke-width="1.5" fill="none"/>
                </svg>
        ...
        <transition name="fade">
            <section class="incense_container" v-if="showlicenseImg" @click="showlicenseImg = false">
                <img alt="" :src="imgBaseUrl+licenseImg" />
            </section>
        </transition>
