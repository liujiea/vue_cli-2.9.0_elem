            ...
            <section>
                ...
                <section class="shop_status_container">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>工商执照注册号</p>
                            <p>{{shopDetail.identification.identification_agency}}</p>
                        </li>
                        <li>
                            <p>注册资本</p>
                            <p>{{shopDetail.identification.regisered_name}}</p>
                        </li>
                        <li>
                            <p>注册地址</p>
                            <p>{{shopDetail.identification.regisered_address}}</p>
                        </li>
                        <li>
                            <p>属地监管所</p>
                            <p>{{shopDetail.identification.regisered_principal}}</p>
                        </li>
                        <li>
                            <p>法定代表人</p>
                ...
                <section class="license_img shop_status_container">
                    ...
                    <div class="img_container">
                        <img src="" alt="" :src="baseUrl ? imgBaseUrl + shopDetail.license.business_license_img: getImgPath(shopDetail.licence.business_license_image)" />
                        <img alt="" :src="baseUrl ? imgBaseUrl + shopDetail.license.catering_service_license_image: getImgPath(shopDetail.licence.catering_service_license_image)" />
                    </div>
                </section>
            </section>
        </section>
