    ...
    <div class="rating_page">
        ...
        <section v-if="!showLoading">
            <section class="category_title">
                ...
                <span :class="{choosed: categoryType === 2}" @click="categoryType = 2">商家代金卷</span>
            </section>
            ...
            <transition name="router-fade">
                <section v-if="categoryType === 2" class="voucher_container">
                    <section class="hongbao_description voucher_header">
                        <img src="../../images/description.png" height="24" width="24" />
                        <router-link to="/benefit/coupon" class="hongbao_detail">商家代金卷说明</router-link>
                    </section>
                    <section class="unable_user">
