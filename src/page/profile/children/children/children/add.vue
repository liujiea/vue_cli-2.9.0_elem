        ...
        <section class="adddetaile">
            <form action="" v-on:submit.prevent>
                <section class="ui-padding-block">
                    ...
                    <div class="input-new">
                        <input type="text" placeholder="请填写详细送餐地址" :class="{verifies: verifythree}" @input="inputThingthree" v-model="mesthress" />
    ...
    export default {
        ...
        methods: {
            ...
            inputThingthree() {
                ...
                if (this.mesthress.length == 0) {
                    this.sendaddress = '请详细填写送餐地址';
                } else if(this.mesthress.length > 0 && this.mesthress.length <= 2){
            ...
            bindThing() {
                if (this.message && this.mesthress && !this.verifyfour) {
                    this.butpart = true;
                } else {
                    this.butpart = false;
                }
            ...
            //保存地址
            async submitThing() {
                let res = await postAddAddress(this.userInfo.user_id, this.mesthress, this.addAddress, this.geohash, this.message, this.telenum, this.standbytelenum, 0, 1, '公司', 4);
                if(res.message) {
                    this.showAlert = true;
