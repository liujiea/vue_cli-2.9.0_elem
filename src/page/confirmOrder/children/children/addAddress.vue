            ...
            <section class="section_list">
                ...
                <section class="section_right">
                    <div class="phone_add">
                        ...
                        <img src="../../../../images/add_phone.png" alt="" height="20" width="20" @click="phone_bk = true" />
                    </div>
                    <input type="text" v-if="phone_bk" name="anntherPhoneNumber" placeholder="备选电话" v-model="anntherPhoneNumber" class="input_style phone_bk" />
                </section>
            </section>
            <section class="section_list">
