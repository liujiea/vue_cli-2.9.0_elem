        ...
        <section v-if="!showLoading">
            ...
            <section class="food_list">
                <header v-if="checkoutData.cart.restaurant_info">
                    <img src="" alt="" :src="imgBaseUrl+checkoutData.cart.restaurant_info.image_path" />
                ...
                <div class="food_item_style">
                    <p class="food_name ellipsis">配送费
                        <div class="num_price">
                            <span></span>
                            <span>￥{{checkoutData.cart.extra[0].price}}</span>
                        </div>
                ...
                <div class="food_item_style total_price">
                    <p class="food_name ellipisis">订单￥{{checkoutData.cart.total}}</p>
                    <div class="num_price">
            ...
            async initAddress() {
                if (this.userInfo && this.userInfo.user_id) {
                    ...
                    if (addressRes instanceof Array && addressRes.length) {
                        this.CHOOSE_ADDRESS({addrss: addressRes[0], index: 0});
                    }
                }
            },
            //显示付款方式
